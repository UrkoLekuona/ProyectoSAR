...
<head>
  ...
  <style>
    ...
    <script>
      function initMap() {
        var uluru = {lat: 43.30713739999999, lng: -2.010857699999974};
...
<body>
  ...
  <!-- Primary Page Layout
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
	<input class="btnlogout" type="button" value="LOGOUT" style="margin-right: 5%; margin-top: 1%; float: right;"/>
	...
	<div class="nav" style="margin-left: 5%; width: 90%;">
		...
		<a class="active" href="contactos.php">Contacto</a>
	</div>
	...
	<div class="formu1">
        ...
        <p aling="center"><b>Sobre nosotros</b></p>
        <p>El equipo de Photobook cuenta con 3 miembros fundadores en el año 2017. La idea surgió un día sin haberlo planeado y ahora se ha convertido en la segunda mayor web de fotografía gracias a vosotros </p>
       
        <p>Jose Caballero (CEO, co-founder)</p>
        <p>Julen Aja (CEO, co-founder)</p>
        <p>Urko Lekuona (CEO, Founder)</p>
        <p></br></p>
        <p>Para poneros en contacto con nosotros únicamente teneis que rellenar el formulario y se contestará en un plazo de dos dias laborables</p>
	...
	<div class="formu2">
	 <form class='contacto' method='post' action='EnviarMensaje.php'>
            <div><label>Tu Nombre:</label><input id='user' type='text' value='<?php echo $_SESSION['user'];?>' readonly></div>
            <div><label>Tu Email:</label><input id='email' type='text' value='<?php echo $_SESSION['email'];?>' readonly></div>
            <div><label>Asunto:</label><input id='asunto' type='text' value=''></div>
            <div><label>Mensaje:</label><textarea id='mensaje' rows='6'></textarea></div>
            <div><input id='enviar' type='button' value='Envia Mensaje'></div>
			<script>
			$('#enviar').click(function(){
				...
				$.ajax({
					...
					data: { username: username, email: email, asunto: asunto, mensaje: mensaje},
